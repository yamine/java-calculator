...
/**
 * This class define the operator expression
 * This could be LET, MULT, DIV or ADD.
 * It defines a compute method that has specific task for LET expression
 * since this latter should have at least 3 arguments and has a variable expression
 * as a first argument.
 * 
...
public class OperatorExpression extends Expression {
    ...
    final private static Logger logger = LogManager.getLogger(OperatorExpression.class);
    ...
    /**
     * Computes the expression for LET, ADD, MULT and DIV
     * @param varList
     * @return Integer
     */
	...
	if (this.exprType == LET) {
	    ...
	    varList.put(a.getVariableName(), b.compute(varList));
